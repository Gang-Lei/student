...
<center><font color=black size=7 >学生成绩添加页面</font></center>
<body>
	<div id="box">
		<div id="mid">
			<div id="denglu">
				...
				onsubmit="greeting()"
					...
					<table width="100%" height="94" border="0" cellpadding="0"
						cellspacing="0">
						<tr>
							<td width="121" height="35" align="right"><font color=black size=5 >学号：</font></td>
							<td width="121" align="left">
										<input type="text" id="id" name="id" class="bian"
											size="18" value="${CUSTOMER_NAME}">*</td>
						</tr>
						<tr>
							<td height="35" align="right"><font color=black size=5 >姓名：</font></td>
							<td align="left"><input type="text" id="name"
								name="name" class="bian" size="18">*</td>
						</tr>
						<tr>
							<td height="35" align="right"><font color=black size=5 >性别：</font></td>
