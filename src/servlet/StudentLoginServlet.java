...
import cn.itcast.jdbc.example.dao.StudentDao;
...
public class StudentLoginServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Student returncustomer = customerDao.findUserByUsernameAndPassword(username, password);
            if (returncustomer != null) {
                request.getSession().setAttribute("student", returncustomer);
